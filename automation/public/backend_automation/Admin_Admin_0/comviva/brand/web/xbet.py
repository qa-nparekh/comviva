...
class XBetWeb:
    ...
    def generateOTP(self, brandurl, mobilenumber,countrycode):
        ...
        try:
            ...
            self.dynamicwait(By.XPATH,'(//a[@href="/en/registration"])[1]').click()
            # time.sleep(5)
            ...
            self.dynamicwait(By.XPATH,"(//span[contains(.,'+ 91')])[2]").click()
            time.sleep(5)

            driver.find_element(By.XPATH,'//input[@class="input__field input-field"]').send_keys(countrycode)
            time.sleep(5)

            driver.find_element(By.XPATH,"//bdi[contains(.,"+str(countrycode)+")]").click()
            time.sleep(5)
            ...
            try:
                ...
                driver.find_element(By.XPATH, "//button[contains(.,'Verify')]")
