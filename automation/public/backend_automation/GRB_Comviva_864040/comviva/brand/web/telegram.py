...
class TelegramWeb:
    ...
    def generateOTP(self, brandurl, mobilenumber,countrycode):
        ...
        try:
            ...
            # self.dynamicwait(By.XPATH,"//span[contains(.,'Log in by phone Number')]").click()
            # time.sleep(5)

            self.dynamicwait(By.XPATH,'//div[@class="c-ripple"]').click()
            time.sleep(5)
            ...
            driver.find_element(By.XPATH,'(//div[@class="c-ripple"])[2]').click()
            print('found')

            if self.dynamicwait(By.XPATH,'//input[@class="input-field-input"]') is None:
