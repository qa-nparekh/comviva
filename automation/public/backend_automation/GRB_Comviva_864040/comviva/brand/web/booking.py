#Booking.comWeb URL
# https://www.booking.com/index.html?aid=898409&label=affnetawin-index_pub-78888_site-1693794_pname-Skimlinks_plc-_ts-hilltopinfo.com/_clkid-6776_1663338808_683d1d77b720471362fa321761c6d2b3&awc=6776_1663338808_683d1d77b720471362fa321761c6d2b3&utm_source=affnetawin&utm_medium=&utm_term=index&utm_content=78888
import json
...
class BookingWeb:
    ...
    def generateOTP(self, brandurl, mobilenumber,countrycode):
        ...
        try:
            ...
            self.dynamicwait(By.XPATH,'(//a[@class="bui-button bui-button--secondary js-header-login-link"])[1]').click()
            time.sleep(5)
