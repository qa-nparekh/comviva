        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-3">
                ...
                <div class="card-toolbar">
                    ...
                    @endphp
                    <a href="{{ asset('public/backend_automation/'.str_replace(' ', '_', $logindata['first_name'])."_".str_replace(' ', '_', $logindata['last_name'])."_".$logindata['user_no'].'/comviva/data/BrandDetails.xlsx') }}" class="btn btn-icon  mr-4" style="background: #1D6F42 !important;" download title="Download excel file">
