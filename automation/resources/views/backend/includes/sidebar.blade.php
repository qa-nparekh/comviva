    ...
    <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
        ...
        <div id="kt_aside_menu" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
            ...
            <ul class="menu-nav">
                ...
                <li class="menu-item {{ ( $currentRoute == 'update-xml-report' || $currentRoute  ==  "admin-system-setting"   || $currentRoute  ==  "audit-trails"   || $currentRoute  ==  "my-report"   || $currentRoute  ==  "admin-update-profile" || $currentRoute  ==  "admin-change-password" || $currentRoute  ==  "smtp-setting"     ? 'menu-item-active' : '' ) }} " aria-haspopup="true">
                    <a href="{{ route('my-report') }}" class="menu-link">
                        ...
                        <span class="menu-text">XML Reports</span>
                    </a>
                </li>

                <li class="menu-item {{ ( $currentRoute  ==  "mobile-report"  ? 'menu-item-active' : '' ) }} " aria-haspopup="true">
                    <a href="{{ route('mobile-report') }}" class="menu-link">
                        <span class="svg-icon menu-icon">
                            <!--begin::Svg Icon | path:assets/media/svg/icons/Design/Layers.svg-->
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
